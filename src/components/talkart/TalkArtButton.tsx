...
export const TalkArtButton: React.FC<TalkArtButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-orange-500 hover:bg-orange-600 text-white border-orange-600 shadow-orange-500/50',
    secondary: 'bg-gray-600 hover:bg-gray-700 text-white border-gray-700 shadow-gray-500/50',
    choice: 'bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-purple-600 shadow-purple-500/50'
  }
...
export const StartButton: React.FC<StartButtonProps> = ({ onClick, disabled = false }) => {
  return (
    <TalkArtButton
      onClick={onClick}
      disabled={disabled}
